...
CASES: list[dict[str, Any]] = [
    ...
    {"name": "a scene id a camera cannot name", "value": changed(scene_id="scene 1"),
     "error": "scene_id must be an id"},
    ...
    {"name": "a unit with no id", "value": unit(0, id="  "),
     "error": "realization.units[0].id must be an id, letters, digits and . _ - starting with a letter or digit, got '  '"},
    {"name": "a unit id a camera cannot name", "value": unit(0, id="shot 1"),
     "error": "realization.units[0].id must be an id"},
